...
| 教学计划容易被对话修改 | `COURSE_PLAN.md` 作为教学锚点，**只有外部学习才能触发计划变更** |
...
这个 skill 本身就是我学习 skill 设计的第一个实战产出。在完成 teach skill 的 4 节课后，我发现了上述痛点，设计了 better_learn。它也是对 teach 6 个设计模式（三级渐进加载、有状态工作区、格式即合约、哲学驱动决策、ZPD、具体产出物）的实战应用。
